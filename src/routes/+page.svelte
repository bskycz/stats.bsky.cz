        ...
        <td>
          <div>
            <div class="text-xs flex gap-1 items-center">
              ...
              {numbro(user.replyCountSum).format({ average: true, optionalMantissa: true, mantissa: 1 })}
            </div>
            <div class="text-xs flex gap-1 items-center">
              ...
              {numbro(user.repostCountSum).format({ average: true, optionalMantissa: true, mantissa: 1 })}
            </div>
            <div class="text-xs flex gap-1 items-center">
              ...
              {numbro(user.likeCountSum).format({ average: true, optionalMantissa: true, mantissa: 1 })}
            </div>
          </div>
        </td>
